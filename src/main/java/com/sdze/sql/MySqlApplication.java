...
public class MySqlApplication implements CommandLineRunner {
	...
	//	uniterep.save(u12);uniterep.save(u13);
		...
		/*
		 * student.save(el1); student.save(el2); student.save(el3);
		 * student.save(el4);student.save(el5); student.save(el6);student.save(el7);
		 * student.save(el8);student.save(el9); student.save(el10); student.save(el11);
		 * student.save(el12); student.save(el13);
		 * student.save(el14);student.save(el15); student.save(el16);student.save(el17);
		 * student.save(el18);student.save(el19); student.save(el20);
		 * 
		 * student.save(el1); student.save(el2);
		 */
